...
/**
 * Воспроизводит аудиофайл формата wav и mp3, позволяет ставить на паузу и начинать заново.
 */
...
public:
     ...
     * Конструирует плеер
     *
     * \param state_caller Функция, которая будет вызываться при изменении его состояния.
     */
